...
//     let booksController: OrderItemController;
//     let booksService: OrderItemService;
//     let request_: any;
//     let user: IUser = {
//         id: '1',
//         firstName: '',
...
//     }
//
//     let createBook: CreateOrderItemDto = {
...
//                         create: jest
//                             .fn()
//                             .mockImplementation((book: CreateOrderItemDto) =>
...
//         }).compile();
//
//         booksController = app.get<OrderItemController>(OrderItemController);
//         booksService = app.get<OrderItemService>(OrderItemService);
//     });
//
