...
describe('BooksController', () => {
    let booksController: ProductController;
    let booksService: ProductService;
    let request_: any;
    // let user: IUser = {
    //     id: '1',
    //     firstName: '',
    ...
    beforeEach(async () => {
            ...
            providers: [ //  <---------- THIS IS THE MOST IMPORTANT SECTION TO SOLVE THIS ISSUE.
                {
                    ...
                    useValue: {
                        create: jest
                            .fn()
                            .mockImplementation((book: CreateProductDto) =>
        ...
        booksController = app.get<ProductController>(ProductController);
        booksService = app.get<ProductService>(ProductService);
    });
