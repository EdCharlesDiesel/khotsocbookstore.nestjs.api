...
describe('BooksController', () => {
    let booksController: PaymentController;
    let booksService: PaymentService;
    let request_: any;
    let user: IUser = {
        id: '1',
        firstName: '',
    ...
    let createBook: CreatePaymentDto = {
    ...
    beforeEach(async () => {
            ...
            providers: [ //  <---------- THIS IS THE MOST IMPORTANT SECTION TO SOLVE THIS ISSUE.
                {
                    ...
                    useValue: {
                        create: jest
                            .fn()
                            .mockImplementation((book: CreatePaymentDto) =>
        ...
        booksController = app.get<PaymentController>(PaymentController);
        booksService = app.get<PaymentService>(PaymentService);
    });
